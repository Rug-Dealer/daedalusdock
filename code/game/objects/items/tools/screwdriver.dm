...
/obj/item/wrench/disco_flavor(mob/living/carbon/human/user, nearby, is_station_level)
	. = ..()
	user.disco_made_easy("screw_eye", 8, /datum/rpg_skill/bloodsport, is_examine=TRUE, success_text = "Small. Inconspicuous. Shaped just right to gouge someone's eye out.") // clues you in to the "eyestab" element
